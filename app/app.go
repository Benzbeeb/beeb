...
import (
	...
	beebmodule "github.com/Benzbeeb/beeb/x/beeb"
	beebmodulekeeper "github.com/Benzbeeb/beeb/x/beeb/keeper"
	beebmoduletypes "github.com/Benzbeeb/beeb/x/beeb/types"
...
type App struct {
	*baseapp.BaseApp
	...
	BeebKeeper beebmodulekeeper.Keeper
...
func New(
	...
	app.BeebKeeper = *beebmodulekeeper.NewKeeper(
		appCodec,
		keys[beebmoduletypes.StoreKey],
		keys[beebmoduletypes.MemStoreKey],
		app.GetSubspace(beebmoduletypes.ModuleName),
	)
	beebModule := beebmodule.NewAppModule(appCodec, app.BeebKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(beebmoduletypes.ModuleName)
