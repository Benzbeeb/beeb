...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=beeb \
	-X github.com/cosmos/cosmos-sdk/version.ServerName=beebd \
...
install: go.sum
	go install -mod=readonly $(BUILD_FLAGS) ./cmd/beebd



release: go.sum
	env GOOS=linux GOARCH=amd64 \
		go build -mod=readonly -o ./build/beebd_linux_amd64 $(BUILD_FLAGS) ./cmd/beebd
	env GOOS=darwin GOARCH=amd64 \
		go build -mod=readonly -o ./build/beebd_darwin_amd64 $(BUILD_FLAGS) ./cmd/beebd
	env GOOS=windows GOARCH=amd64 \
		go build -mod=readonly -o ./build/beebd_windows_amd64 $(BUILD_FLAGS) ./cmd/beebd
	env GOOS=linux GOARCH=amd64 \
